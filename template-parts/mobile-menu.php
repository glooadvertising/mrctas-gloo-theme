    ...
    <section class="mobile-menu-content text-mrct-navy-light flex grow flex-col items-start justify-between gap-6 p-6 md:px-12">
        <ul>
            <li class="group py-2"><a href="">Our services</a>
                <section class="purple-sub menu-hide group-hover:transition-all group-hover:duration-1000 group-hover:left-0 flex flex-col items-start cursor-pointer bg-mrct-lilac-light text-white absolute w-full h-full top-0">
                    <div class="flex w-full">
                        <header class="btmm hover:bg-mrct-lilac-dark border-b border-mrct-lilac-dark w-full py-8 px-6 gap-6 text-xl font-extrabold flex flex-row items-center justify-start">
